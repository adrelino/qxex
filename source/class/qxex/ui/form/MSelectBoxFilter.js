...
qx.Mixin.define("qxex.ui.form.MSelectBoxFilter", {
  properties: {
    ...
    // setTextFilterExcludeItems(false);
    textFilterExcludeItems: {
      check: "Boolean",
      init: true
    },
  ...
  members: {
    addFilterTextField(textField, filterListFun) {
      ...
      if (!textField) {
        ...
        this.addListener("keydown", e => {
          //does not work using keypress in firefox, needs 2 inputs to focus and type text into textfield. See also https://github.com/qooxdoo/qooxdoo/issues/9626
          var iden = e.getKeyIdentifier();
          if (iden == "Down" || iden == "Up" || iden == "Enter" || iden == "Escape" || iden == "Tab") {
            return;
          }
        ...
        this.__filterTextField.addListener("keypress", e => {
          var iden = e.getKeyIdentifier();
      ...
      popup.addListener("changeVisibility", e => {
    ...
    __filterList(filterText, filterCheckBoxValue) {
