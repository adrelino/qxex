  ...
  members: {
    ...
    */
    ...
    _onPointerUpDown(e) {
      ...
      if (target == this.getChildControl("minLabel") || target == this.getChildControl("currLabel") || target == this.getChildControl("maxLabel")) {
        e.stopPropagation();
        return;
      }
    }
